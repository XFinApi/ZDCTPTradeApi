/*******************************************************
* ZDCTPTradeApiSimpleDemoCSharp2015
* www.xfinapi.com
*******************************************************/
using System;
...
namespace ZDCTPTradeApiSimpleDemoCSharp2015
{
    class Program
    {
        //////////////////////////////////////////////////////////////////////////////////
        ...
        static void MarketTest()
        {
            ...
            openParams.Configs.Add("LoginAddress", Cfg.TradeAddress);
        ...
        static void TradeTest()
        {
            ...
            openParams.UserID = Cfg.UserName;
            openParams.Password = Cfg.Password;
            openParams.Configs.Add("CurrencyNo", Cfg.CurrencyNo);//设置币种，底层根据币种选择默认资金账户
            openParams.IsUTF8 = true;
